...
class CodeForm(forms.Form):
    code = forms.CharField(label="代码", widget=forms.Textarea(attrs={'class': 'code-input'}))
    question_id = forms.IntegerField(label="题目id",
                                     widget=forms.TextInput(attrs={'hidden': 'hidden', 'id': 'question_id'}))
